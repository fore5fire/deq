...
func (HelloType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_greeter_6a99f3e9aac01525, []int{0}
}
...
func (*HelloReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_greeter_6a99f3e9aac01525, []int{1}
}
...
func init() {
	proto.RegisterFile("example/greeter/greeter.proto", fileDescriptor_greeter_6a99f3e9aac01525)
}

var fileDescriptor_greeter_6a99f3e9aac01525 = []byte{
